  ...
  return (
    <>
      ...
      <div className="company-container">
        ...
        <p>Proud of its 200-year-old heritage, Runflat Tire Systems  also has all the attributes of a small business: responsiveness, focused expertise and ease to do business with.</p>
      </div>
      <div className="company-section1">
        <h2>Our History and Heritage</h2>
        <p>Runflat Tire Systems  was established in 2001 as a subsidiary of its parent company Westley Plastics using its leading edge polymer technology to exclusively develop run-flat tyre insert systems.</p>
        <p>Runflat Tire Systems  originates from Westley Group, a india leading non-ferrous foundry and engineering group since the beginning of the 19th century in the cradle of the industrial revolution.</p>
        ...
        <p>Runflat Tire Systems  is a subsidiary and partner of Westley Plastics which specialises exclusively in run-flat systems. Our composite material has been developed and is processed specifically for run-flat applications while our products are subject to multiple patents.</p>
        <p>Recently Wheels International was established to work in parallel with Runflat Tire Systems  and specialise in lightweight, high load military/security alloy and steel wheels manufactured in India.</p>
      </div>
      <div className="company-section2">
        <h2>Operational Excellence</h2>
        <p>Runflat Tire Systems  has full ISO 9001:2015 certification. Operational excellence is achieved through state of the art machinery, polymerisation expertise and regularly audited quality standards.</p>
      ...
      <div className="company-section3-img">
        <img src={factory_img1} alt="" /><br />
        <img src={factory_img2} alt="" /><br />
        <img src={iso_img} alt="" />
      </div>
      ...
      <div className="company-section-4">
        <strong><h3>Runflat Tire Systems  offers the flexibility and fast responsiveness of a small business whilst relying on operational excellence.
